package com.android.toolkitlibrary.refresh.recyclerview;
...
import com.android.toolkitlibrary.refresh.XRefreshView;
...
public abstract class BaseRecyclerAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    public void addFooterView() {
        FFLogUtil.d("","test addFooterView");
        if (removeFooter) {
    ...
    public void removeFooterView() {
        FFLogUtil.d("","test removeFooterView");
        if (!removeFooter) {
