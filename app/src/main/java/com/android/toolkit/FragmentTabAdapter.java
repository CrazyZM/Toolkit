...
public class FragmentTabAdapter implements View.OnClickListener {
    ...
    private LinearLayout linearLayout; // 用于切换tab
     ...
     * 目前仅支持三层布局，
     * 1.父控件为LinearLayout，
     * 2.子控件每项必须为LinearLayout，
     * 3.子控件的子控件顺序必须为image和textview
     */
    public FragmentTabAdapter(FragmentActivity fragmentActivity,
                              List<Fragment> fragments, int fragmentContentId, LinearLayout linearLayout) {
            ...
            if (linearLayout.getChildAt(i).getId() == view.getId()) {
                ...
                if (null != onRgsExtraCheckedChangedListener) {
                    onRgsExtraCheckedChangedListener.OnRgsExtraCheckedChanged(
                            (LinearLayout) view, view.getId(), i);
                }
    ...
    public static class OnRgsExtraCheckedChangedListener {
        public void OnRgsExtraCheckedChanged(LinearLayout linearLayout,
